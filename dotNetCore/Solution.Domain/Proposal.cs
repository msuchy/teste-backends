...
namespace Solution.Domain
{
  public class Proposal
  {
    ...
    public bool SingleMainProponent()
    {
      int mainProponentNumber = Proponents.Count(p => p.IsMain);
      return mainProponentNumber == 1;
    }
    ...
    public bool MinimumNumberProponents()
    {
      return Proponents.Count >= 2;
    }

    public bool ProponentAge()
    {
